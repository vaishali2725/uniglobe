...
<html lang="en">
    ...
    <body class=" login">
        ...
        <!-- BEGIN LOGIN -->
        <div class="content">
            <form class="login-form" action="<?php echo base_url(); ?>updatepassword" method="POST">
			 ...
			 <input type="hidden" name="u_id" value="<?php echo $id;?>" />
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="newpassword" /> </div>
                </div>
                <div class="form-actions">
                   <input type="submit" class="btn green pull-right" name="submit" value="Reset">
                </div>
            </form>
        </div>
        <!-- END LOGIN -->
